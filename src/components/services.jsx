  ...
  return (
    <section className='bg-color-dark p-5 text-white flex flex-col justify-center gap-5'>
        <article className='text-center'>
            ...
            <h2 className='text-2xl'>Personalized solutions for specific requirementx</h2>
        </article>
        <article className='grid grid-cols-6 gap-5'>
            ...
            <div className='col-span-6 sm:col-span-3 lg:col-span-2 flex flex-col gap-2 rounded-xl border-2 border-color-gray p-3 m-2'>
                ...
                <h3 className='text-xl'>Database Management</h3>
                <p className='text-gray-500'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Necessitatibus voluptates eaque quos unde quam natus, 
                    .sequi nobis ab cupiditate reprehenderit deleniti debitis aperiam
            ...
            <div className='col-span-6 sm:col-span-3 lg:col-span-2 flex flex-col gap-2 rounded-xl border-2 border-color-gray p-3 m-2'>
                ...
                <h3 className='text-xl'>API REST Development</h3>
                <p className='text-gray-500'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Necessitatibus voluptates eaque quos unde quam natus, 
                    .sequi nobis ab cupiditate reprehenderit deleniti debitis aperiam
            ...
            <div className='col-span-6 sm:col-span-3 lg:col-span-2 flex flex-col gap-2 rounded-xl border-2 border-color-gray p-3 m-2'>
                ...
                <h3 className='text-xl'>Robust solutions</h3>
                <p className='text-gray-500'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Necessitatibus voluptates eaque quos unde quam natus, 
                    .sequi nobis ab cupiditate reprehenderit deleniti debitis aperiam
            ...
            <div className='col-span-6 sm:col-span-3 lg:col-span-2 flex flex-col gap-2 rounded-xl border-2 border-color-gray p-3 m-2'>
                ...
                <h3 className='text-xl'>Ecommerce solutions</h3>
                <p className='text-gray-500'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Necessitatibus voluptates eaque quos unde quam natus, 
                    .sequi nobis ab cupiditate reprehenderit deleniti debitis aperiam
            ...
            <div className='col-span-6 sm:col-span-3 lg:col-span-2 flex flex-col gap-2 rounded-xl border-2 border-color-gray p-3 m-2'>
                ...
                <h3 className='text-xl'>Technical Consulting & Optimization</h3>
                <p className='text-gray-500'>
